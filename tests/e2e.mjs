...
// =========================================================================
{
	...
	await page.locator('[data-testid="rad-input"]').fill('4');
	await page.locator('[data-testid="rad-input"]').blur();
	...
	expect('reload: rad persisted', '4', await page.locator('[data-testid="rad-input"]').inputValue().catch(() => '?'));
